...
void NaiveSequentialSimulation::calculate_forces(Universe& universe){
    for(std::uint32_t body_idx = 0; body_idx < universe.num_bodies; body_idx++){
        // get body positions
        ...
        for(std::uint32_t distant_body_idx = 0; distant_body_idx < universe.num_bodies; distant_body_idx++){
